...
export const interviewResponses = [
  ...
  // PRANEETH (Interview 8)
  {
    participant: 'Praneeth',
    age: 'Late 20s',
    gender: 'Male',
    location: 'Calicut, Kerala',
    userType: 'Advanced (Recovering)',
    responses: {
      'Q1': 'Praneet Ravi, UX Strategist from Calicut, Kerala',
      'Q2': 'Calicut, Kerala, India',
      'Q3': 'Wake 5:30-6am, meditation, yoga, morning walks/jogging. Protein-rich breakfast, work, lunch by 2pm, evening pooja, sometimes walking, classes until 10pm, sleep 11:30pm. Now 7hrs sleep (was 1-2hrs, took 6-7 months to fix).',
      'Q4': 'Was hardcore fitness freak previously. Had to stop due to health issues (fainting, autoimmune disorders, hospital admissions). Now recovering with focus on holistic wellness - mental + physical + nutritional.',
      'Q5': 'Initially: weight gain and fitness goals. Now: Recovery from health crisis, mental wellness foundation, sustainable holistic health.',
      'Q6': 'Mental wellness (primary), sustainable fitness routine, recovery from health setbacks, balance physical and mental fitness.',
      'Q7': 'Currently: daily yoga/meditation, walking/light jogging. Previously: 6 days intense gym training',
      'Q8': 'Morning: 30-60 min yoga/meditation. Walking as time permits. Previously: 2+ hours intense training',
      'Q9': 'Previously gym. Now: Home/outdoor - yoga, meditation, walking. Doctors suggested outdoor activities better for mental health than indoor.',
      'Q10': 'Solo preference but values human guidance. Prefers friend motivation over trainer. Not interested in social comparison features.',
      'Q11': 'Yoga, meditation, walking, light jogging. Previously: intense gym, biking (was part of leading team in India)',
      'Q12': 'Yes. Currently works with yoga/psychology expert AND traditional gym trainer. Both provide different aspects - mental wellness + physical guidance.',
      'Q13': 'Structured diet from mentor. Protein-rich breakfast (nuts), fruits mid-morning, rice-based lunch (South Indian staple), evening tea/snack, dinner 8-8:30pm. Adapts to regional Kerala foods.',
      'Q14': 'Previously tracked meticulously with smartwatch. Now: Manual journaling - feels "more human" and connected. Avoids over-tracking micromanagement.',
      'Q15': 'Diet changes frequently with body conditions. Need adaptive plans, not static. Previously: no single holistic solution - had to run after multiple people for mental/physical/nutrition.',
      'Q16': 'Previously: Whey (concentrate then isolate), Creatine, BCAAs. Now: Minimal supplements, focusing on natural diet.',
      'Q17': 'No specific meal prep mentioned. Focus on regional food availability and listening to body.',
      'Q18': 'Tried MANY fitness apps but none stuck - felt too mechanical and impersonal. Used smartwatches (Noise, Samsung) but stopped on doctor advice (radiation concerns).',
      'Q19': 'Previously tracked everything with smartwatch. Now avoids over-tracking - causes stress and obsession ("800 steps enough, but track 1000 = over exhausted").',
      'Q20': 'MAJOR issues: Apps feel mechanical/impersonal, lack human touch, not truly personalized (just height/weight), over-gamification creates stress, too much micromanagement, apps fragment solution (need mental+physical+nutrition in ONE).',
      'Q21': 'Used Noise and Samsung smartwatches. Stopped because: 1) Doctor advised radiation/laser health concerns, 2) Over-tracking created unhealthy obsession, 3) Manual journaling felt more human.',
      'Q22': 'Yes, uses ChatGPT + research + expert consultation. Does NOT rely on one AI source. Wants human touch despite being tech-savvy UX professional.',
      'Q23': 'Finding ONE holistic solution (mental + physical + nutrition). Apps too mechanical. Body adaptation after health crisis.',
      'Q24': 'Not consistency issue - it\'s finding adaptive plans for changing body conditions. Static plans don\'t work.',
      'Q25': 'Work stress was major factor in health crisis (remote work 6 years led to introvert zone, intense work without balance). Now prioritizes mental wellness.',
      'Q26': 'Not mentioned as current issue.',
      'Q27': 'Yes. Micro-management creates stress. Prefers solution-focused positive messaging over problem-focused. Comparing with others demotivates - different body structures/situations.',
      'Q28': 'Mental peace, recovery from health crisis, holistic health. Motivation from seeing improvement when started going outdoor (vs indoor workout).',
      'Q29': 'Values human guidance but prefers self-motivation over social features. Friend motivation helpful.',
      'Q30': 'NO. Self-comparison okay, but comparing with others doesn\'t make sense. Different body structures, situations. Social comparison demotivates.',
      'Q31': 'Works with yoga/psychology expert + traditional gym trainer. Medium spend on holistic health.',
      'Q32': 'Medium range ($20-50/month) IF truly holistic solution (mental + physical + nutrition integrated).',
      'Q33': 'ONE platform for mental+physical+nutrition (CRITICAL), adaptive plans for changing body conditions, human touch/live chat support, non-wearable tracking options, positive solution-focused messaging, regional food awareness (Kerala), anti-over-tracking features, recovery-focused gradual progression, Ayurveda integration, self-progress comparison (NO social leaderboards), manual journaling option'
    }
  },
  ...
  // REYENA (Interview 9)
  {
    ...
    userType: 'Beginner',
    responses: {
      'Q1': 'Reyena, 30 years old, homemaker',
      'Q2': 'Pune, India',
      'Q3': 'Kids to school morning, free daytime (binge-watching), kids playtime after school, kids classes, evenings completely free. Walk 7,000 steps daily on terrace while kids play.',
      'Q4': 'Started walking about a year ago. Did yoga during pregnancy with daily instructor. No fitness routine beyond walking currently.',
      'Q5': 'No specific motivation - "I simply started to walk"',
      'Q6': 'Weight loss (was 60kg, gained weight), home workout routine, balanced nutrition, consistency in fitness.',
      'Q7': 'Daily walking (7k steps). Looking to add 3 days/week structured workouts.',
      'Q8': 'Currently just walking while supervising kids. Wants 30-min to 1-hour workout sessions.',
      'Q9': 'Home workouts - cannot go to gym due to childcare responsibilities. Wants 30-minute follow-along workout videos.',
      'Q10': 'Prefers working out alone at home. Solo preference.',
      'Q11': 'Walking (current), interested in yoga (did during pregnancy), wants basic home exercises.',
      'Q12': 'Had yoga instructor during pregnancy (daily). Husband in fitness industry provides nutrition advice but doesn\'t follow it completely.',
      'Q13': '"I\'m kind of a foodie. I eat a lot of junk food." Main issue: CRAVINGS. Even when trying to eat healthy, craves junk and ends up cheating.',
      'Q14': 'Does NOT track nutrition currently but very interested. Wants to track calories to make better food choices.',
      'Q15': 'Food cravings (#1 challenge). "I crave junk. So I end up cheating." Wants healthier alternatives to cravings.',
      'Q16': 'Took vitamins during pregnancy (folic acid, calcium, iron). Not taking any currently.',
      'Q17': 'Has time to cook/prepare healthy meals but main barrier is cravings for junk food.',
      'Q18': 'Uses "Steps: Step Counter Pedometer" app on Android phone for daily step tracking.',
      'Q19': 'Tracks: Steps (7,000/day), manually tracks menstrual cycle (regular, 2nd day heavy with leg pain)',
      'Q20': 'Not much app experience. Looking for home workout + nutrition app. Privacy concerns about location tracking.',
      'Q21': 'No wearable devices currently.',
      'Q22': 'AI is "okay but human touch would be great. So that I could know 100% genuine." Prefers human guidance over pure AI.',
      'Q23': 'Food cravings (PRIMARY challenge), finding time with kids schedule, motivation/consistency, lack of structured routine, equipment availability.',
      'Q24': 'Time constraints with kids, "every day there might be something or the other coming up", equipment needs upfront communication.',
      'Q25': 'Not mentioned (homemaker).',
      'Q26': 'Not mentioned.',
      'Q27': 'YES. Wants ONLY 1 pre-workout + 1 post-workout notification. Continuous notifications = annoying = would delete app.',
      'Q28': 'Both visible progress AND external compliments motivate. Family support (husband in fitness) provides positive motivation.',
      'Q29': 'Prefers self-progress tracking. "I would go for myself. I\'ll get to know what I have improved."',
      'Q30': 'Prefers weekly self-comparison over social leaderboards. "I\'ll get to know what\'s going on and what\'s not going on" with own progress.',
      'Q31': 'Only paid for yoga instructor during pregnancy.',
      'Q32': 'Budget-conscious (homemaker). Looking for value and affordability.',
      'Q33': 'Home workout + nutrition integration (CRITICAL), 30-minute follow-along videos, calorie tracking with healthier alternatives to cravings, recipe suggestions, live chat support for posture/nutrition doubts, pre/post workout meal notifications, weekly self-progress tracking, minimal app permissions, equipment list beforehand, 3x/week workout schedule, Indian food measurements (not vague "1 cup")'
    }
  }
]
