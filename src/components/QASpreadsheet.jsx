...
const QASpreadsheet = () => {
  ...
  const exportToCSV = () => {
    // Create CSV header
    let csv = 'Question ID,Category,Journey Stage,Question,Amish (27M Advanced),Aniket (Mid-20sM Intermediate),Majid (Late 20s-30sM Intermediate),Jessica (36F Intermediate)\n'
